...
input_path  = os.path.join(BASE_PATH, "bronze", "food_nutrition")
output_path = os.path.join(BASE_PATH, "silver", "food_nutrition_clean")
...
run_checks([
    ...
    # Numeric columns must already be cast (not strings) coming out of raw_to_bronze
